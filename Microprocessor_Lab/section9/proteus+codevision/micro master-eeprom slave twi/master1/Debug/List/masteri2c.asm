...
_0x3:
	.DB  0x0,0x10,0x10,0x20,0x30,0x40,0x50,0x60
	.DB  0x70,0x80
_0x2000003:
	.DB  0x7
...
; 0000 0024 unsigned char tx_data[10]={0x00,0x10,0x10,0x20,0x30,0x40,0x50,0x60,0x70,0x80};  //added
; 0000 0025 unsigned char rx_data[10];   //added
; 0000 0026 unsigned char *txp=&tx_data[0]; //added
; 0000 0027 unsigned char *rxp=&rx_data[0];  //added
; 0000 0028 
...
; 0000 0043 // Mode: TWI Master
; 0000 0044 // Bit Rate: 100 kHz
; 0000 0045 twi_master_init(100);
	LDI  R26,LOW(100)
	LDI  R27,0
...
; 0000 004B 
; 0000 004C 
; 0000 004D  twi_master_trans(0x50, txp ,10,rxp,0);   // for wite to eeprom
	LDI  R30,LOW(80)
	ST   -Y,R30
	ST   -Y,R17
	ST   -Y,R16
...
; 0000 004E  delay_ms(5);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 004F  twi_master_trans(0x50, txp ,2,rxp,10);   //for read from eeprom
	LDI  R30,LOW(80)
	ST   -Y,R30
	ST   -Y,R17
	ST   -Y,R16
